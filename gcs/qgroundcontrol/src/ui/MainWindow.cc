...
void MainWindow::_buildCommonWidgets(void)
{
    ...
    connect(mavlinkDecoder,SIGNAL(valueChanged(int,QString,QString,QVariant,quint64)),this,SLOT(messageReceived(int,QString,QString,QVariant,quint64)));
    // Log player
...
void MainWindow::messageReceived(const int uasId, const QString& name, const QString& unit, const QVariant& value, const quint64 msec) {
    Q_UNUSED(uasId);
    Q_UNUSED(name);
    Q_UNUSED(unit);
    Q_UNUSED(value);
