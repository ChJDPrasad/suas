...
Item {
    ...
    property real _altitudeAMSL:        _activeVehicle ? _activeVehicle.altitudeAMSL        : _defaultAltitudeAMSL
    property real _altitudeRelative:    _activeVehicle ? _activeVehicle.altitudeRelative    : _defaultAltitudeRelative
    property real _groundSpeed:         _activeVehicle ? _activeVehicle.groundSpeed * 5/18  : _defaultGroundSpeed
    property real _airSpeed:            _activeVehicle ? _activeVehicle.airSpeed * 5/18     : _defaultAirSpeed
    ...
    property real pipSize:              mainWindow.width * 0.3
